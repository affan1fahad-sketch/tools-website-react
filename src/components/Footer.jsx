      ...
      <div className="footer-inner">
        <div className="footer-brand">
          <div className="footer-logo">
            <svg width="28" height="28" viewBox="0 0 36 36" fill="none"><rect width="36" height="36" rx="9" fill="#2563eb"/><polygon points="21,5 11,19 17,19 9,31 23,15 16,15" fill="white"/></svg>
            <span>ToolKit</span>
          </div>
        ...
        <div className="footer-links-group">
          ...
          <div className="footer-col">
            ...
            <NavLink to="/percentage-calculator">Percentage Calc</NavLink>
          </div>
          <div className="footer-col">
            <h4>Site</h4>
